...
contract MasterVaultScenario06Test is MasterVaultCoreTest {
    ...
    function test_scenario06_profitClaimedThenLoss() public {
        ...
        assertEq(
            vault.totalProfit(MathUpgradeable.Rounding.Down),
            0,
            "Total profit should be 0 after loss"
        );
    ...
    /// @dev Scenario: Deposits, profit, fee claim, then loss before redemption, 100% allocation
    function test_scenario06_profitClaimedThenLoss_100PercentAllocation() public {
