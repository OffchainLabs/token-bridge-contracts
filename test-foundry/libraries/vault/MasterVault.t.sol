...
contract AttackTest is MasterVaultTestWithSubvaultFresh {
    function _calculateStolenAmount(
        ...
        uint128 initialSubVaultTotalSupply, // added to subvault total assets to get something close to 1 to 1
    ...
    function testFindCombo(
        ...
        int8 initialSubVaultTotalSupplyWiggle, // added to subvault total assets to get something close to 1 to 1
        uint128 vaultInitialDepositAmount,
        uint128 vaultAttackDepositAmount
    ) public {
        vm.assume(initialSubVaultTotalAssets > 1e18);
        vm.assume(vaultInitialDepositAmount > 1e18);
